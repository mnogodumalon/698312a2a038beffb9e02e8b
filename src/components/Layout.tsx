...
import { FileText, FolderKanban, LayoutDashboard, Menu, Settings, Undo2 } from 'lucide-react';
import { useState, useEffect } from 'react';
import ChatWidget from '@/components/ChatWidget';
import { TopBar } from '@/components/TopBar';

// ⚡ Customize these for your app
const APP_TITLE = 'Test-Management';
...
const navigation = [
  ...
  { name: 'Testprojekte', href: '/testprojekte', icon: FolderKanban },
  { name: 'Testausführungen', href: '/testausfuehrungen', icon: FileText },
  { name: 'Testfälle', href: '/testfaelle', icon: FileText },
];

const externalNavigation = [
  { name: 'Testprojekte', href: '/gateway/apps/69831269d2f08ae9c50e685c?template=list_page', icon: FolderKanban },
  { name: 'Testausführungen', href: '/gateway/apps/69831276eb4690de26587cf0?template=list_page', icon: FileText },
  { name: 'Testfälle', href: '/gateway/apps/698312754560a97404d76b75?template=list_page', icon: FileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69831269d2f08ae9c50e685c?template=list_page"
